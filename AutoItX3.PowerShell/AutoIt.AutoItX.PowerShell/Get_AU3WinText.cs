...
[Cmdlet("Get", "AU3WinText")]
public class Get_AU3WinText : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (!(parameterSetName == "Text"))
        {
            ...
            {
                ((Cmdlet)this).WriteObject((object)AutoItX.WinGetText(winHandle, 65535), true);
            }
        }
        else
        {
            ((Cmdlet)this).WriteObject((object)AutoItX.WinGetText(title, text, 65535), true);
        }
    }
}
