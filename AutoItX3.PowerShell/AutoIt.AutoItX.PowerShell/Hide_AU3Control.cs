...
[Cmdlet("Hide", "AU3Control", DefaultParameterSetName = "Text")]
public class Hide_AU3Control : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (!(parameterSetName == "Text"))
        {
            ...
            {
                ((Cmdlet)this).WriteObject((object)AutoItX.ControlHide(winHandle, controlHandle), true);
            }
        }
        else
        {
            ((Cmdlet)this).WriteObject((object)AutoItX.ControlHide(title, text, control), true);
        }
    }
}
