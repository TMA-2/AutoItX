...
[Cmdlet("Set", "AU3ControlFocus", DefaultParameterSetName = "Text")]
public class Set_AU3ControlFocus : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (!(parameterSetName == "Text"))
        {
            ...
            {
                ((Cmdlet)this).WriteObject((object)AutoItX.ControlFocus(winHandle, controlHandle), true);
            }
        }
        else
        {
            ((Cmdlet)this).WriteObject((object)AutoItX.ControlFocus(title, text, control), true);
        }
    }
}
