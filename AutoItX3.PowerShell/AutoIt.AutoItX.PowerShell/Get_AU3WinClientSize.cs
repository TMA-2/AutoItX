...
[Cmdlet("Get", "AU3WinClientSize", DefaultParameterSetName = "Text")]
public class Get_AU3WinClientSize : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (!(parameterSetName == "Text"))
        {
            ...
            {
                ((Cmdlet)this).WriteObject((object)AutoItX.WinGetClientSize(winHandle), true);
            }
        }
        else
        {
            ((Cmdlet)this).WriteObject((object)AutoItX.WinGetClientSize(title, text), true);
        }
    }
}
