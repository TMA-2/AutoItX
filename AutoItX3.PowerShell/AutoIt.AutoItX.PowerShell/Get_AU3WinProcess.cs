...
[Cmdlet("Get", "AU3WinProcess")]
public class Get_AU3WinProcess : PSCmdlet
{
    ...
    protected override void ProcessRecord()
    {
        ...
        if (!(parameterSetName == "Text"))
        {
            ...
            {
                ((Cmdlet)this).WriteObject((object)AutoItX.WinGetProcess(winHandle, 65535), true);
            }
        }
        else
        {
            ((Cmdlet)this).WriteObject((object)AutoItX.WinGetProcess(title, text, 65535), true);
        }
    }
}
