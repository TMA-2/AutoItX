...
```
Enable-AU3Control [-Title] <string> [[-Text] <string>] [[-Control] <string>] [<CommonParameters>]
```

### Handle

```
Enable-AU3Control [-WinHandle] <IntPtr> [-ControlHandle] <IntPtr> [<CommonParameters>]
```
...
This example demonstrates basic usage of the Enable-AU3Control cmdlet.
