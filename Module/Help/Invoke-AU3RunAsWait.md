...
Runs an external program with credentials and waits for completion.
...
```
Invoke-AU3RunAsWait [-User] <string> [-Domain] <string> [-Password] <string> [[-LogonFlag] <int>]
...
This example demonstrates basic usage of the Invoke-AU3RunAsWait cmdlet.
