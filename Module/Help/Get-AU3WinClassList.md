...
A string containing the window class names.

## NOTES

This cmdlet is based on the WinGetClassList() AutoIt function and provides Windows automation capabilities.

## RELATED LINKS

[Function Documentation](https://www.autoitscript.com/autoit3/docs/functions/WinGetClassList.htm)
