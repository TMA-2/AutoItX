...
```
Get-AU3WinText [-Title] <string> [[-Text] <string>] [<CommonParameters>]
```

### Handle

```
Get-AU3WinText [-WinHandle] <IntPtr> [<CommonParameters>]
```
...
This example demonstrates basic usage of the Get-AU3WinText cmdlet.
